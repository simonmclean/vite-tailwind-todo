export default function() {
  return (
    <header className="px-6 py-2 border-b-slate-700 border-b flex items-center">
      <div className="prose">
        <h1 className="text-slate-300 text-xl">💪 Vitey Todo App</h1>
      </div>
      <a href="https://github.com/simonmclean/vite-tailwind-todo" className="block ml-auto text-slate-200">
